...
import { Id64, Logger, assert, ActivityLoggingContext } from "@bentley/bentleyjs-core";
...
export class ChangesetGenerator {
    ...
    public constructor(private _accessToken: AccessToken, private _hubUtility: HubUtility,
        ...
        private _activityLoggingContext: ActivityLoggingContext,
        private _iModelDbHandler: IModelDbHandler = new IModelDbHandler(_activityLoggingContext),
        private _seed = Date.now().toString()) {
    ...
    private async pushTestChangeSet(testChangesetSequence: TestChangesetSequence) {
        ...
        await this._iModelDb!.pushChanges(this._activityLoggingContext, this._accessToken, () => description);
    }
